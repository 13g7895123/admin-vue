<template>
    <div class="relative w-screen h-screen bg-loginBg bg-cover bg-no-repeat bg-center flex">
        <section class="w-[370px] h-[210px] justify-center items-center text-center">
